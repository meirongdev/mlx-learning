...
Note: the older figure "Qwen3.6-27B-4bit (dense) = 10.6 tok/s (M2 Pro)" — now carried in
[`../performance.md`](../performance.md) — is **not directly comparable**: it predates this 2026
hybrid-attention VLM checkpoint and almost certainly referred to a standard-attention 27B.
Re-measure M2 Pro on this exact checkpoint for an apples-to-apples gap.
